    ...
    <div class="plan-detail-mobile shadow">
      <div class="d-flex gap-3 plan-btn">
        <button
          ...
          :class="{ active: dm_plan == 'hourly' }"
          @click="dm_plan = 'hourly'"
        >
          Hourly
        </button>
        <button
          class="btn primary-btn"
          :class="{ active: dm_plan == 'monthly' }"
          @click="dm_plan = 'monthly'"
        >
          Monthly
        </button>
        <button
          class="btn primary-btn"
          :class="{ active: dm_plan == 'one_year' }"
          @click="dm_plan = 'one_year'"
        >
          1 Year
        </button>
        <button
          class="btn primary-btn"
          :class="{ active: dm_plan == 'three_year' }"
          @click="dm_plan = 'three_year'"
        >
          3 Year
        </button>
      </div>
      ...
      <div class="plan-mobile-detail">
          ...
          >
            ...
            <div class="col-6">
              <div class="d-flex justify-content-end gap-3">
                <span
                  class="price-tag"
                  v-if="dm_plan == 'hourly' && dm_os == 'linux'"
                  >$0.034</span
                >
                <span
                  class="price-tag"
                  v-if="dm_plan == 'monthly' && dm_os == 'linux'"
                  >$24​</span
                >
                <span
                  class="price-tag"
                  v-if="dm_plan == 'one_year' && dm_os == 'linux'"
                  >$266</span
                >
                <span
                  class="price-tag"
                  v-if="dm_plan == 'three_year' && dm_os == 'linux'"
                  >$798</span
                >
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card8' }"
        >
          <div
            class="row"
            @click="toggleActiveCard('card8')"
            data-bs-toggle="collapse"
          ...
          >
            ...
            <div class="col-6">
              <div class="d-flex justify-content-end gap-3">
                ...
                <span
                  class="price-tag"
                  v-if="dm_plan == 'hourly' && dm_os == 'window'"
                  >$0.086</span
                >
                <span
                  class="price-tag"
                  v-if="dm_plan == 'monthly' && dm_os == 'window'"
                  >$59​</span
                >
                <span
                  class="price-tag"
                  v-if="dm_plan == 'one_year' && dm_os == 'window'"
                  >$649</span
                >
                <span
                  class="price-tag"
                  v-if="dm_plan == 'three_year' && dm_os == 'window'"
                  >$1,752</span
                >
                <span class="material-symbols-outlined"> expand_more</span>
              </div>
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card9' }"
        >
          <div
            class="row"
            @click="toggleActiveCard('card9')"
            data-bs-toggle="collapse"
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card10' }"
        >
          <div
            class="row"
            @click="toggleActiveCard('card10')"
            data-bs-toggle="collapse"
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card11' }"
        >
          <div
            class="row"
            @click="toggleActiveCard('card11')"
            data-bs-toggle="collapse"
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card12' }"
        >
          <div
            class="row"
            @click="toggleActiveCard('card12')"
            data-bs-toggle="collapse"
        ...
        <div
          v-if="dm_os == 'window'"
          class="plan-detail-card"
          :class="{ active: active_card == 'card13' }"
        >
          <div
            class="row"
            @click="toggleActiveCard('card13')"
            data-bs-toggle="collapse"
