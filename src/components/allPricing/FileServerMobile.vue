<template>
  <div class="price-item" style="margin-top: 60px">
    ...
    <p style="padding-left: 30px">
      Cloud based NAS server provides distributed file services such as file
      sharing, permission, encryption, sync and data migration. Access your data
      rapidly from anywhere and at anytime.​​​
    </p>
    <div class="plan-detail-mobile shadow">
      <div class="d-flex gap-3 plan-btn mb-5">
        <button
          class="btn primary-btn"
          :class="{ active: fs_plan == 'hourly' }"
          @click="fs_plan = 'hourly'"
        >
          Hourly
        </button>
        <button
          class="btn primary-btn"
          :class="{ active: fs_plan == 'monthly' }"
          @click="fs_plan = 'monthly'"
        >
          Monthly
        </button>
        <button
          class="btn primary-btn"
          :class="{ active: fs_plan == 'one_year' }"
          @click="fs_plan = 'one_year'"
        >
          1 Year
        </button>
        <button
          class="btn primary-btn"
          :class="{ active: fs_plan == 'three_year' }"
          @click="fs_plan = 'three_year'"
        >
          3 Year
        </button>
      </div>
      <div class="plan-mobile-detail">
        <div
          ...
          :class="{ active: active_card == 'card14' }"
        >
          <div
            class="row"
            data-bs-toggle="collapse"
            @click="toggleActiveCard('card14')"
          ...
          >
            ...
            <div class="col-6">
              <div class="d-flex justify-content-end gap-3">
                ...
                <span class="price-tag" v-if="fs_plan == 'three_year'"
                  >$897</span
                >
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card15' }"
        >
          <div
            class="row"
            data-bs-toggle="collapse"
            @click="toggleActiveCard('card15')"
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card16' }"
        >
          <div
            class="row"
            data-bs-toggle="collapse"
            @click="toggleActiveCard('card16')"
            data-bs-target="#collapseExample15"
          >
            ...
            <div class="col-6">
              <div class="d-flex justify-content-end gap-3">
                <span
                  class="price-tag"
                  v-if="fs_plan == 'hourly' && fs_os == 'linux'"
                  >$0.175</span
                >
                <span
                  class="price-tag"
                  v-if="fs_plan == 'monthly' && fs_os == 'linux'"
                  >$120​</span
                >
                <span
                  class="price-tag"
                  v-if="fs_plan == 'one_year' && fs_os == 'linux'"
                  >$1,200</span
                >
                <span
                  class="price-tag"
                  v-if="fs_plan == 'three_year' && fs_os == 'linux'"
                  >$3,600</span
                >
                <span class="material-symbols-outlined"> expand_more</span>
              </div>
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card17' }"
        >
          <div
            class="row"
            data-bs-toggle="collapse"
            @click="toggleActiveCard('card17')"
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card18' }"
        >
          <div
            class="row"
            data-bs-toggle="collapse"
            @click="toggleActiveCard('card18')"
            data-bs-target="#collapseExample17"
          >
        ...
        <div
          class="plan-detail-card"
          :class="{ active: active_card == 'card19' }"
        >
          <div
            class="row"
            data-bs-toggle="collapse"
            @click="toggleActiveCard('card19')"
