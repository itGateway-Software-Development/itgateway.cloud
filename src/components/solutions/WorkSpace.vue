            ...
            const items =[
                {
                    prefix: "Elastic",
                    name: "Workspace​",
                    description : "Virtual Desktop as a Services for Windows & Linux Desktop users​.​"
                },
                {
                    prefix: "Elastic​",
                    name: "NAS Server",
                    description : "Cloud based NAS storage to share and manage file access​.​​"
                },
                {
                    prefix: "Elastic​",
                    name: "Virtual Office",
                    description : "Digital workspace platform like Microsoft 365​.​"
                },
            ];
