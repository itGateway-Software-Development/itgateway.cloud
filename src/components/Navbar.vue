<template>
  <div class="nav-wrapper">
    <nav class="pb-1">
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="top-menu">
          ...
          <router-link
            to=""
            class="menu d-flex align-items-center position-relative"
          >
    ...
    <nav
      class="main-nav pt-0 position-relative d-flex align-items-center"
      :class="{ active: isScroll }"
    >
      <router-link
        to=""
        class="menu"
        :class="{ active: route.path.slice(0, 8) == '/explore' }"
      ...
      <router-link
        to=""
        class="menu"
        :class="{ active: route.path.slice(0, 8) == '/pricing' }"
        @mouseenter="menuHover(true)"
        @mouseleave="menuHover(false)"
      >
      ...
      >
      <router-link
        to="/company/about-company"
        class="menu"
        :class="{ active: route.path.slice(0, 8) == '/company' }"
        @mouseenter="menuHover(true)"
        @mouseleave="menuHover(false)"
      >
